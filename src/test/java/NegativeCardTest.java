...
public class NegativeCardTest {
    ...
    @Test
    void wrongName() {
        driver.findElement(By.cssSelector("[data-test-id=name] input")).sendKeys("My Name");
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("+79922233333");
    ...
    void wrongPhoneNumber() {
        ...
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("89342123777");
        driver.findElement(By.cssSelector("[data-test-id=agreement]")).click();
        driver.findElement(By.cssSelector("button.button")).click();
    ...
    void withoutCheckbox() {
        ...
        driver.findElement(By.cssSelector("[data-test-id=phone] input")).sendKeys("89222237777");
        driver.findElement(By.cssSelector("button.button")).click();
